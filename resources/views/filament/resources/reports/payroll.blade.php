...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/payroll-report.css') }}">
        ...
        <div class="payroll">
            <table>
                <thead class="headerTable">
                    <tr>
                        <th colspan="14">
                            <h2 style="text-align: left;">Período planilla: Del {{ $from }} Al
                                {{ $to }}</h2>
                        </th>
                        <th colspan="2">
                ...
                <tbody>
                    @foreach ($payrollData['agencies'] as $agency)
                        ...
                        @if (count($agencyEmployees) > 0)
                            <!-- Mostrar solo agencias con empleados -->
                            <tr>
                            ...
                            @foreach ($payrollData['charges'] as $charge)
                                ...
                                @if (count($filteredData) > 0)
                                    <!-- Mostrar solo cargos con empleados -->
                                    <tr>
